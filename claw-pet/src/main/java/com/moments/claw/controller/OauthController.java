 ...
 */
@Api(tags = "OauthController控制层", value = "/oauth")
@RestController
...
public class OauthController extends BaseController {
    ...
    public TableDataInfo<?> selectAll() {
        startPage();
        return getDataTable(oauthService.list());
    }
    ...
    public R<?> selectOne(@ApiParam(name = "id", value = "id", required = true) @PathVariable Serializable id) {
        return R.success(this.oauthService.getById(id));
    }
    ...
    @PostMapping
    public R<?> insert(@RequestBody Oauth oauth) {
        return R.success(this.oauthService.save(oauth));
    }
    ...
    @PutMapping
    public R<?> update(@RequestBody Oauth oauth) {
        return R.success(this.oauthService.updateById(oauth));
    }
    ...
    public R<?> delete(@ApiParam(name = "idList", value = "id数组", required = true) @RequestParam("idList") List<Long> idList) {
        return R.success(this.oauthService.removeByIds(idList));
    }
}
